...
async fn wizard_provision_run(
    ...
    let result = tauri::async_runtime::spawn_blocking(move || {
        ...
        let ctx = wcmd::WizardCtx { db, keystore, staging_dir, cli, clock };
...
fn recipient_identity_get_or_create(
    ...
    daal_wizard::recipient_identity::get_or_create(&wstate.0, &pin).map_err(|e| e.to_string())
}
...
fn recipient_import_sbpx(
    ...
    daal_wizard::recipient_sbpx::import_sbpx(&wstate.0, &p, &pin)
