...
type providerFace interface {
	Provision(ctx context.Context, opts provider.ProvisionOpts) (*provider.OperatorRecord, error)
	Reprovision(ctx context.Context, rec *provider.OperatorRecord, opts provider.ReprovisionOpts) error
	Decommission(ctx context.Context, rec *provider.OperatorRecord) error
	AssignFloatingIP(ctx context.Context, rec *provider.OperatorRecord, fipID string) error
	UnassignFloatingIP(ctx context.Context, rec *provider.OperatorRecord) error
	Pricing(ctx context.Context, rec *provider.OperatorRecord) (provider.Pricing, error)
}
