...
const MAIN_ROWS: RowSpec[] = [
    ...
    { id: 'routes', key: 'nav.routes', shortcut: '⌘2', icon: ICON_ROUTES },
    { id: 'sources', key: 'nav.subs', shortcut: '⌘3', icon: ICON_SOURCES },
    { id: 'status', key: 'nav.status', shortcut: '⌘4', icon: ICON_STATUS },
    { id: 'settings', key: 'nav.settings', shortcut: '⌘5', icon: ICON_SETTINGS },
];
